...
function Footer() {
  return (
    <div id="Contact" className="lg:flex flex-1 lg:justify-evenly  lg:w-[1340px] w-[100%]  lg:h-[208px] h-auto bg-[#BFDBFF] m-auto py-[41px] lg:px-[111px] px-[50px] lg:mb-[22px] mb-0 flex-wrap">
      <div>
        <h1 className="font-Rubik font-[700] text-[16px] leading-[35.36px] lg:text-start text-center">
          Social
        </h1>
        <ul className="text-[#2C2C2C] font-Rubik font-[400] text-[14px] leading-[30.94px] lg:text-start text-center">
